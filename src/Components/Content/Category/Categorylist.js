...
import {faList,faPen,faPlus,faTrash
...
export default function Categorylist() {
    return (
        <>
            <Pageheader
                pageheader_header="Kateqoriyalar"
                pageheader_description="Kateqoriyalar"
                pageheader_icon="fas fa-folder"
            />
            <Breadcrumb/>
            <div className="content">
                <div className="button-group mb-2">
                    <Link to="/category/add" type="button" className="btn btn-labeled btn-labeled-left btn-success mr-2 mb-1">
                        <b>
                        ...
                        <div className="card-header-body">
                            ...
                            <div className="card-header-body-content">
                                ...
                                <span className="card-header-body-content--description">
                                    Kateqoriyaların listinə baxa, tənzimləyə və ya silə bilərsiniz
                                </span>
                            </div>
                        </div>
                    </div>
