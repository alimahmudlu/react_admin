...
import {
    faExclamationTriangle,faFolderOpen,faList,faTimes
...
export default function CategoryAdd() {
    return (
        <>
            <Pageheader
                pageheader_header="Kateqoriya əlavə et"
                pageheader_description="Kateqoriya əlavə edərkən diqqətli olun. Etdiyiniz səhv səhifə strukturunu poza bilər!"
                            ...
                            <div className="card-header-body">
                                ...
                                <div className="card-header-body-footer">
                                    <div className="custom-control custom-switch custom-switch-big">
                                        <input type="checkbox" className="custom-control-input" id="category_visible"/>
                                        <label className="custom-control-label" htmlFor="category_visible"> </label>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="card">
                        <div className="card-body">
                            <div className="form-group d-flex mb-0">
                                ...
                                </button><button type="submit" className="btn btn-info ml-auto">
                                    Əlavə et
