...
export default function PagesList() {
    return (
        <>
            <Pageheader
                pageheader_header="Səhifələr"
                pageheader_description="Səhifələr"
                        ...
                        <div className="card-header-body">
                            ...
                            <div className="card-header-body-content">
                                ...
                                <span className="card-header-body-content--description">
                                    Səhifələrin listinə baxa, tənzimləyə və ya silə bilərsiniz
                                </span>
                            </div>
                        </div>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div className="d-flex">
                                            <Link to="/pages/edit" className="btn btn-success mr-2">
