...
export default function PostCategoryAdd() {
    return (
        <>
            <Pageheader
                pageheader_header="Post Kateqoriyası əlavə et"
                pageheader_description="Post kateqoriyası əlavə edərkən diqqətli olun. Etdiyiniz səhv post strukturunu poza bilər!"
                pageheader_icon="fas fa-file-alt"
            />
            <Breadcrumb/>
            <div className="content">
                <div className="button-group mb-2">
                    <Link to="/post/category" type="button" className="btn btn-labeled btn-labeled-left btn-success mr-2 mb-1">
                        <b>
