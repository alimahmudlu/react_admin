...
export default function PostList() {
    return (
        <>
            <Pageheader
                pageheader_header="Postlar"
                pageheader_description="Postlar"
                pageheader_icon="fas fa-newspaper"
            />
            <Breadcrumb/>
            <div className="content">
                <div className="button-group mb-2">
                    <Link to="/post/add" type="button" className="btn btn-labeled btn-labeled-left btn-success mr-2 mb-1">
                        <b>
                        ...
                        <div className="card-header-body">
                            ...
                            <div className="card-header-body-content">
                                ...
                                <span className="card-header-body-content--description">
                                    Postların listinə baxa, tənzimləyə və ya silə bilərsiniz
                                </span>
                            </div>
                        </div>
                    </div>
